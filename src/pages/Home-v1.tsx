        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-4xl">
            <h1 className="text-5xl lg:text-6xl font-light text-gray-900 mb-8 leading-tight">
              Turn your data into 
              <span className="text-blue-600 font-medium"> strategic advantage</span>
            </h1>
            <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-3xl">
              I help organizations uncover insights, optimize performance, and make confident 
              decisions through thoughtful data analysis and strategic consulting.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded font-medium transition-colors">
                Start a conversation
              </button>
              <button className="border border-gray-300 hover:border-blue-600 text-gray-700 hover:text-blue-600 px-8 py-4 rounded font-medium transition-colors">
                View my work
              </button>
            </div>
          </div>
